...
"#!/bin/bash
tag=$(curl -sI https://github.com/ourfor/mpv/releases/latest | grep 'location: https://github.com/ourfor/mpv/releases' | sed 's#.*/##g' | tr -d '\r')
printf 'https://github.com/ourfor/mpv/archive/%s.tar.gz' $tag")
